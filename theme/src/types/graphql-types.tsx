...
export type Unnamed_3_Query = {
  allMdx: Maybe<{
    edges: Array<{
      node: Pick<Mdx, 'id' | 'timeToRead' | 'excerpt'> & {
        fields: Maybe<Pick<MdxFields, 'url' | 'title' | 'date'>>
        frontmatter: Maybe<{ banner: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }>
      }
    }>
  }>
}
...
export type Unnamed_4_Query = {
  mdx: Maybe<
    Pick<Mdx, 'id' | 'timeToRead' | 'body' | 'excerpt'> & {
      fields: Maybe<Pick<MdxFields, 'title' | 'date'>>
      frontmatter: Maybe<{ banner: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }>
    }
  >
}
