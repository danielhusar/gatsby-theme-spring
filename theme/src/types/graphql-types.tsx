...
export type SitePageFieldsEnum = 
  ...
  'context___pagination___pages' |
  'context___pagination___currentPage' |
  'context___pagination___pageCount' |
  'context___pagination___pathPrefix' |
  'context___id' |
  'pluginCreator___id' |
...
export type SitePluginFieldsEnum = 
  ...
  'pluginOptions___gatsbyRemarkPlugins___options___maintainCase' |
...
export type Unnamed_1_Query = { portrait: Maybe<{ childImageSharp: Maybe<{ fixed: Maybe<GatsbyImageSharpFixedFragment> }> }> };

export type SiteTitleQueryQueryVariables = {};


export type SiteTitleQueryQuery = { site: Maybe<{ siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'keywords' | 'language'>> }> };

export type Unnamed_2_QueryVariables = {};


export type Unnamed_2_Query = { portrait: Maybe<{ childImageSharp: Maybe<{ fixed: Maybe<GatsbyImageSharpFixedFragment> }> }> };

export type Unnamed_3_QueryVariables = {};


export type Unnamed_3_Query = { allMdx: Maybe<{ edges: Array<{ node: (Pick<Mdx, 'id' | 'timeToRead' | 'excerpt'> & { fields: Maybe<Pick<MdxFields, 'url' | 'title' | 'date'>>, frontmatter: Maybe<{ banner: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }> }) }> }> };
...
export type Unnamed_4_Query = { mdx: Maybe<(Pick<Mdx, 'id' | 'timeToRead' | 'body' | 'excerpt'> & { fields: Maybe<Pick<MdxFields, 'title' | 'date'>>, frontmatter: Maybe<{ banner: Maybe<{ childImageSharp: Maybe<{ fluid: Maybe<GatsbyImageSharpFluidFragment> }> }> }> })> };
